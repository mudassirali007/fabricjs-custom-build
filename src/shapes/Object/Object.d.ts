...
import type { TDegree, TFiller, TSize, TCacheCanvasDimensions, Abortable } from '../../typedefs';
import type { Group } from '../Group';
import type { Image } from '../Image';
import type { SerializedObjectProps } from './types/SerializedObjectProps';
import type { ObjectProps } from './types/ObjectProps';
import type { TProps } from './types';
export type TCachedFabricObject<Props extends TProps<ObjectProps> = Partial<ObjectProps>, SProps extends SerializedObjectProps = SerializedObjectProps, EventSpec extends ObjectEvents = ObjectEvents> = FabricObject<Props, SProps, EventSpec> & Required<Pick<FabricObject<Props, SProps, EventSpec>, 'zoomX' | 'zoomY' | '_cacheCanvas' | '_cacheContext' | 'cacheTranslationX' | 'cacheTranslationY'>> & {
...
export declare class FabricObject<Props extends TProps<ObjectProps> = Partial<ObjectProps>, SProps extends SerializedObjectProps = SerializedObjectProps, EventSpec extends ObjectEvents = ObjectEvents> extends AnimatableObject<EventSpec> implements ObjectProps {
     ...
     * @returns {Promise<FabricObject>}
     */
    static fromObject<T extends TProps<SerializedObjectProps>>(object: T, options?: Abortable): Promise<FabricObject<Partial<ObjectProps>, SerializedObjectProps, ObjectEvents>>;
}
