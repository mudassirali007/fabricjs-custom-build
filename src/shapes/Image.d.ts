...
export declare class Image<Props extends TProps<ImageProps> = Partial<ImageProps>, SProps extends SerializedImageProps = SerializedImageProps, EventSpec extends ObjectEvents = ObjectEvents> extends FabricObject<Props, SProps, EventSpec> implements ImageProps {
    ...
    protected _filteredEl?: HTMLCanvasElement;
     ...
     * @param {CanvasRenderingContext2D} ctx Context to render on
     */
    drawCacheOnCanvas(this: TCachedFabricObject<Props, SProps, EventSpec> & {
        imageSmoothing: boolean;
     ...
     */
    static fromObject<T extends TProps<SerializedImageProps>>({ filters: f, resizeFilter: rf, src, crossOrigin, ...object }: T, options?: Abortable): Promise<Image<Omit<T, "crossOrigin" | "filters" | "resizeFilter" | "src"> & {
     ...
     * @returns {Promise<Image>}
     */
    static fromURL<T extends TProps<ImageProps>>(url: string, { crossOrigin, signal }: LoadImageOptions | undefined, imageOptions: T): Promise<Image>;
    /**
     ...
     */
    static fromElement(element: HTMLElement, options?: Abortable, cssRules?: CSSRules): Promise<Image<Partial<ImageProps>, SerializedImageProps, ObjectEvents> | null>;
}
export {};
