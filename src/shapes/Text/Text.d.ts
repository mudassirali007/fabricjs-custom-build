...
import type { Abortable, TCacheCanvasDimensions, TClassProperties, TFiller } from '../../typedefs';
...
export declare class Text<Props extends TProps<TextProps> = Partial<TextProps>, SProps extends SerializedTextProps = SerializedTextProps, EventSpec extends ObjectEvents = ObjectEvents> extends StyledText<Props, SProps, EventSpec> implements UniqueTextProps {
     ...
     */
    static fromElement(element: HTMLElement, options: Abortable, cssRules?: CSSRules): Promise<Text<{
     ...
     */
    static fromObject<T extends TProps<SerializedTextProps>, S extends Text>(object: T): Promise<S>;
}
export {};
