...
export declare const isInteractiveTextObject: (fabricObject?: FabricObject) => fabricObject is IText<Partial<import("../shapes/IText/IText").ITextProps>, import("../shapes/IText/IText").SerializedITextProps, import("../shapes/IText/ITextBehavior").ITextEvents> | Textbox;
export declare const isFabricObjectCached: (fabricObject: FabricObject) => fabricObject is TCachedFabricObject<Partial<import("../shapes/Object/types/ObjectProps").ObjectProps>, import("../..").SerializedObjectProps, import("../EventTypeDefs").ObjectEvents>;
